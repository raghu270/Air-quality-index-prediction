...
def predict():
    ...
    state_city={'Delhi':'delhi','Haryana':'haryana','Uttar_Pradesh':'uttar-pradesh','Maharashtra':'maharashtra','Karnataka':'karnataka','Madhya Pradesh':'madhya-pradesh','West_Bengal':'west-bengal','Rajasthan':'rajasthan','Punjab':'punjab','Telangana':'telangana','Bihar':'bihar','TamilNadu':'tamilnadu','Gujarat':'gujarat','Andhra_Pradesh':'andhra-pradesh','Kerala':'kerala','Odisha':'odisha','Jharkhand':'jharkhand','Assam':'assam','Chandigarh':'chandigarh','Meghalaya':'meghalaya'}
    ...
    poll_dict={'pm2.5':pollutants[0],'pm10':pollutants[1],'so2':pollutants[2],'co':pollutants[3],'ozone':pollutants[4],'no2':pollutants[5]}
